    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('admin.dashboard') }}" class="d-lg-none">
                <img alt="Logo" src="{{ asset(config('project.app.favicon')) }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-400 fw-semibold my-5 my-lg-0 px-2 px-lg-0 align-items-stretch"
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            <!--begin:Menu link-->
                            {{ config('project.app.title') }} | {{ config('project.app.description') }}
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <!--end:Menu sub-->
                        </div>
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        <img alt="{{ Auth::guard('admin')->user()->name }}"
                            src="{{ !empty(Auth::guard('admin')->user()->avatar) ? asset(Auth::guard('admin')->user()->avatar) : asset('assets/backend/media/avatars/blank.png') }}" />
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img src="{{ !empty(Auth::guard('admin')->user()->avatar) ? asset(Auth::guard('admin')->user()->avatar) : asset('assets/backend/media/avatars/blank.png') }}"
                                        alt="image" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
