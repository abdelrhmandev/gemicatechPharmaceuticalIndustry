    ...
    <div id="kt_content_container" class="container-xxl">
        <form id="Add{{ $trans }}" data-route-url="{{ $storeRoute }}" class="form d-flex flex-column flex-lg-row"
                        ...
                        <div class="d-flex flex-column gap-5 mt-5">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <textarea placeholder="{{ __('site.brief') }}" class="form-control form-control-solid tinyEditor" rows="4"
                                    id="brief" name="brief" placeholder=""></textarea>
                            </div>

                        </div>
                    </div>
                </div>
                <x-backend.cms.categories :categories="$categories" />
                <x-backend.cms.child_categories />
            ...
            <div class="d-flex flex-column flex-row-fluid gap-0 w-lg-400px gap-lg-5">
                <x-backend.cms.image />
                <x-backend.cms.brands :brands="$brands" />
                <x-backend.cms.industries :industries="$industries" />
            </div>
        </form>
    </div>
@stop
@push('scripts')
    ...
    <script>
        ...
        // End of Ajax get sub categories
