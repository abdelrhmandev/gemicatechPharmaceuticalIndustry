        ...
        <div class="d-flex flex-lg-row-fluid">
            <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                    src="{{ asset(config('project.app.logo')) }}" alt="" />
                <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                    src="{{ asset('assets/backend/media/auth/agency-dark.png') }}" alt="" />
                <h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">{{ config('project.app.title') }}</h1>
                <div class="text-gray-600 fs-base text-center fw-semibold">{{ config('project.app.description') }}
                ...
                <div class="w-md-400px">
                    ...
                    <form id="login" method="POST" action="{{ route('admin.login.submit') }} " class="form w-100"
                        ...
                        <div class="text-center mb-11">
                            ...
                            <div class="text-gray-500 fw-semibold fs-6">{{ config('project.app.title') }}</div>
                        </div>
