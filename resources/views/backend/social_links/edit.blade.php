                ...
                <div class="card card-flush py-0">
                    <div class="card-body pt-0">
                        <div class="d-flex flex-column gap-5 mt-5">
                            <x-backend.cms.masterInputs :showDescription="0" :richTextArea="0" :showSlug="0" :row="$row" />
                            <div class="fv-row fl">
                                <label class="required form-label"
                                    for="icon">{{ __('site.icon') }}</label>
                                <input placeholder="{{ __('site.icon') }}" type="text" id="icon"
                                    name="icon" class="form-control mb-2" required
                                    data-fv-not-empty___message="{{ __('validation.required', ['attribute' => 'icon']) }}"
                                    value="{{ $row->icon ?? '' }}" />
                            </div>
                            ...
                            <div class="fv-row fl">
                                ...
                                <input placeholder="{{ __('site.link') }}" type="text" id="link"
